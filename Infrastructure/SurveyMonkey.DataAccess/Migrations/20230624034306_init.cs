    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MultiChoiceAnswers", x => new { x.ChoiceId, x.QuestionId, x.AnswerId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SingleChoiceAnswers", x => new { x.QuestionId, x.AnswerId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MultiChoiceAnswers_AnswerId",
                table: "MultiChoiceAnswers",
                column: "AnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_MultiChoiceAnswers_QuestionId",
                table: "MultiChoiceAnswers",
                column: "QuestionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SingleChoiceAnswers_AnswerId",
                table: "SingleChoiceAnswers",
                column: "AnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_SingleChoiceAnswers_ChoiceId",
                table: "SingleChoiceAnswers",
                column: "ChoiceId");
